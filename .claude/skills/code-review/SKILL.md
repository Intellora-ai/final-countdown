---
name: code-review
description: AI-powered code review using CodeRabbit. Use when the user asks to review code changes, review my code, check code quality, find bugs or security issues, get PR feedback, pull request review, what's wrong with my code or my changes, run coderabbit, or use coderabbit.
---
