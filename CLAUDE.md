...
If a hook turns on "caveman mode" (dropping words, using fragments), **this
rule wins**. Fragments are harder to read, not easier. Write full simple
sentences.
...
5. **Say what you skipped and why**, in one line.
...
**Never write down whether it is installed.** That is runtime state. Check,
never recall:
